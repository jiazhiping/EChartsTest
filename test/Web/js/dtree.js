...
function dTree(objName, objbool) {        // void 构造方法，创建树对象。objName: 树名称。objbool：单选多选 true多选  false单选  默认单选         
    ...
    this.icon = {
        ...
        folderOpen:  '../images/folderopen.gif',   // 打开的文件夹,默认'images/folderOpen.gif' 
        node:        '../images/page.gif',         // 打开的文件夹,默认'images/folderOpen.gif' 
        empty:       '../images/empty.gif',        // 打开的文件夹,默认'images/folderOpen.gif' 
        line:        '../images/line.gif',         // 竖线,默认'images/line.gif'
        join:        '../images/join.gif',         // 丁线,默认'images/join.gif' 
        joinBottom:  '../images/joinbottom.gif',   // 直角线,默认'images/joinbottom.gif' 
        plus:        '../images/plus.gif',         // 加号丁线,默认'images/plus.gif' 
        plusBottom:  '../images/plusbottom.gif',   // 加号直角线,默认'images/plusbottom.gif' 
        minus:       '../images/minus.gif',        // 减号丁线,默认'images/minus.gif' 
        minusBottom: '../images/minusbottom.gif',  // 减号直角线,默认'images/minusbottom.gif'  
        nlPlus:      '../images/nolines_plus.gif', // 减号直角线,默认'images/minusbottom.gif' 
        nlMinus:     '../images/nolines_minus.gif' //无线减号,默认'images/nolines_minus.gif' 
    };
...
dTree.prototype.toString = function () {
    var str = '<div id="slimtest1" class="dtree_Tree" style="width: 100%;height: 100%;">\n';
...
dTree.prototype.node = function (node, nodeId) {
    ...
    if (node.pid == this.root.id) {
        ...
        //是否可用
        if (node.cchecked) {
            checkboxSyntax = "<span class='dtree_node' onclick=Return('" + node.id + "') node_id='" + node.id + "'>" + node.cshow + "</span>";
        }
        else {            
            /**组装checkbox开始*/            
